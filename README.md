...
| ⚡ **语言底座** | [agent-skill-golang-base](https://github.com/Garfield247/agent-skill-golang-base) | **地道 Go 语言核心开发规范**：**Uber Go 指针与内存语义**、**防 typed nil 陷阱**、Channel 所有权、Goroutine 泄漏防范、错误包装。 | `skills/golang-base` |
