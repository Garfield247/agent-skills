...
| 📚 **知识管理** | [agent-skill-project-documentation](https://github.com/Garfield247/agent-skill-project-documentation) | **人机双重视角文档体系**：目录自适应探测、**00 号标准约束与红线第一法则**、**AI 进场首读规范**、数字分层目录治理、**Mermaid 4 大防崩语法铁律**。 | `skills/project-documentation` |
...
| 🐍 **语言底座** | [agent-skill-python-base](https://github.com/Garfield247/agent-skill-python-base) | **Python 3.10+ 现代基础规范**：PEP 604 强类型系统 (X \| Y)、可变默认参数避坑、dataclass(slots=True) 高效建模与生成器流式防 OOM。 | `skills/python-base` |
